      ...
      {links.map((link) => {
        ...
        return (
          <Link
            ...
            href={link.href}
            className={clsx(
              "flex h-[48px] grow items-center justify-center gap-1 rounded-md p-1 text-base font-medium hover:bg-mainPageGray hover:text-black md:flex-none md:justify-start md:p-2 md:px-3",
              {
